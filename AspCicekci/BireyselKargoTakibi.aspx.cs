...
{
    public partial class BireyselKargoTakibi : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            con.Open();
            SqlDataAdapter da = new SqlDataAdapter("select * from SiparisBilgilerii where Kullanici_adi='" + Label3.Text + "'", con);
            ...
            for (int i = 1; i <= pds.PageCount; i++)
            {
                ...
                hyper.NavigateUrl = "BireyselKargoTakibi.aspx?sayfa=" + i.ToString();

...
{
    public partial class ButikCicekler : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            con.Open();
            SqlDataAdapter da = new SqlDataAdapter("select * from OnayliCicek where OnayliKategori='Butik Çiçekler'", con);
            ...
            for (int i = 1; i <= pds.PageCount; i++)
            {
                ...
                hyper.NavigateUrl = "ButikCicekler.aspx?sayfa=" + i.ToString();

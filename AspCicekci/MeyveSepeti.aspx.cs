...
{
    public partial class MeyveSepeti : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            con.Open();
            SqlDataAdapter da = new SqlDataAdapter("select * from OnayliCicek where OnayliKategori='meyve sepeti'", con);
            ...
            for (int i = 1; i <= pds.PageCount; i++)
            {
                ...
                hyper.NavigateUrl = "MeyveSepeti.aspx?sayfa=" + i.ToString();
